...
const SearchUsers = ({
    ...
    const createGroup = async function(userId){
        const response = await fetch(`http://localhost:3001/api/create/new/group/${userId}`, {
            method: "POST",
            headers:{
                "token": `${token}`,
            }
    ...
    const setUserInfo = async function(user){
        ...
        try {
            ...
            const response = await fetch(`http://localhost:3001/api/check/group/is/exist/${userId}`, {
                method: "GET",
                headers: {
                    "token": `${token}`,
                }
    ...
    const getUsers = async (data)=>{
        setQuery(data);
        try {
            const response = await fetch(`http://localhost:3001/search/${data}`, {
                method: "GET",
                headers: {
                    "token": `${token}`,
                }
