...
const Main = ({ newMessage,
        ...
        const loadInitialMessages = async (dialogue) => {
            ...
            try {
                ...
                const response = await fetch(
                    `http://localhost:3001/api/messages/${dialogue.group_id}?limit=${limit}&offset=${offset}`,
    ...
    const loadMoreMessages = async () => {
        ...
        try {
            ...
            const response = await fetch(
                `http://localhost:3001/api/messages/${selectedDialogue.group_id}?limit=${limit}&offset=${currentOffset + limit}`,
